...

{
  ...
  "ingredients": [ { "name": "食材名", "amount": "用量或 视频未明确", "note": "可选备注或空字符串" } ],
  "steps": [
    {
      "index": 1,
      "title": "该步小标题",
...
export async function structureRecipe(llm, { transcript, meta }) {
...
${transcript}`;
  ...
  const recipe = await chatJSON(llm, { system: SYSTEM, user, temperature: 0.2 });
