export const TECHNIQUE_TERMS = [
  ...
  { technique: "勾芡", aliases: ["勾芡", "水淀粉", "芡汁", "薄芡"] },
  ...
  { technique: "切配", aliases: ["切片", "切丝", "切丁", "切块", "改刀"] },
  { technique: "拍松", aliases: ["拍松", "拍散", "拍裂"] },
  { technique: "揉面", aliases: ["揉面", "揉成团", "揉光滑"] },
  { technique: "醒发", aliases: ["醒发", "醒面", "发酵", "松弛面团"] },
